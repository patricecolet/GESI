...
On windows we need to install lua-sqlite manually, install lua5.3 windows  [http://luabinaries.sourceforge.net/download.html](32bit binaries), download windows mingw binaries from 
